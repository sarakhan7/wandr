  ...
  return (
    <>
      ...
      <Typography variant="body2" sx={{ textAlign: "center" }}>
        Wandr leverages Gemini 1.5 (Google's LLM) to find places in your new
        city that can facilitate your lifestyle.
      </Typography>
      <Typography variant="body2" mb="1.5rem" sx={{ textAlign: "center" }}>
        First, please answer some questions so Wandr can provide better
        suggestions:
      </Typography>
        ...
        <div style={styles.halfWidth}>
          <Paper variant="outlined" style={styles.paper}>
            ...
            <Typography
              ...
              sx={{ alignSelf: "center", marginBottom: "1.5rem" }}
            >
              Adding your Google Takeout data helps Wandr autofill onboarding
